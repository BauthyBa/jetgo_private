-- ==================================================
-- SISTEMA DE CHAT DE GRUPO (SIN REALTIME) - VERSIÓN CORREGIDA
...
DROP POLICY IF EXISTS "Message senders can update their messages" ON chat_messages;
DROP POLICY IF EXISTS "Message senders can delete their messages" ON chat_messages;
